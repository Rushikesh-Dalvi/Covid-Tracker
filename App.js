 ...
 handleChange =(e)=>{
  ...
  render(){
   ...
   const filteredCountries = stats.filter(country=>(
    ...
    return(
      <div className="App">
       <h1>Covid Status Web App</h1>
       <SearchBox placeholder="Enter Country Name....." handleChange={this.handleChange}></SearchBox>
       <CountryList stats={filteredCountries}></CountryList>
    </div>
    )
  }
}
